 ...
 * Contém navegação, conteúdo principal e rodapé
 */

import { useAuthStore } from "~/store/auth"

const cookieAdmin = useCookie("admin", { sameSite: true })
const cookieImageProfile = useCookie("imageProfile", { sameSite: true })
...
/* Fundo pontilhado da área principal */
.main__background {
	background: white;
