<template>
	<v-app full-height theme="dark">
		...
		<v-main>
			...
			<div class="pa-4">
				<v-btn color="success font-weight-black" @click="dialog = true"
					>Adicionar nova pergunta</v-btn
				>
			</div>
			<div>
				<v-container fluid>
			...
			<v-dialog v-model="dialog" max-width="600px">
				<v-card>
					<v-card-title class="headline"
						>Adicionar Pergunta</v-card-title
					>
					<v-card-text>
						<v-container>
							<v-row>
								...
								<v-col cols="12">
									<v-select
										v-model="novaPergunta.dificuldade"
								...
								<v-col cols="12">
									<v-text-field
										v-model="novaPergunta.imagem"
										label="imagem(link por enquanto)"
										outlined
										dense
									></v-text-field>
								</v-col>
					...
					<v-card-actions>
						<v-btn color="red" text @click="dialog = false"
							>Cancelar</v-btn
						>
						<v-btn color="green" text @click="adicionarPergunta()"
							>Salvar</v-btn
						>
					</v-card-actions>
				</v-card>
			...
			<v-dialog v-model="dialogView" max-width="600px">
				<v-card>
					<v-card-title
						class="headline text-h4 font-weight-bold d-flex justify-center"
						>Detalhes da Pergunta</v-card-title
					>
					<v-card-text>
						<v-divider></v-divider>
						<v-container>
							<v-row>
								<v-col cols="4">
									<strong
										class="pa-4 text-h6 font-weight-bold d-flex justify-center"
										>ID</strong
									>
									<span
										class="pa-4 text-subtitle-1 d-flex justify-center"
									>
									...
									<v-card class="pa-5">
										<v-row class="d-flex justify-center">
											<v-col
												v-for="(
													alt, index
												) in perguntaSelecionada.alternativas"
												:key="index"
												cols="auto"
											>
												<span v-if="index == 0">
								...
								<v-col cols="12">
									...
									><br />
									<img
										v-if="perguntaSelecionada.imagem"
										:src="perguntaSelecionada.imagem"
										width="100%"
										style="border-radius: 5px"
									/>
								</v-col>
					...
					<v-card-actions>
						<v-spacer />
						<v-btn color="red" text @click="dialogView = false"
							>Fechar</v-btn
						>
					</v-card-actions>
				</v-card>
				...
				<v-card>
					...
					<v-card-text>
						<v-container>
							<v-row>
								...
								<v-col cols="12">
									<v-select
										v-model="perguntaEdit.dificuldade"
										:items="['Fácil', 'Médio', 'Difícil']"
										label="Dificuldade"
										outlined
										dense
					...
					<v-card-actions>
						<v-btn color="red" text @click="dialogEdit = false"
							>Cancelar</v-btn
						>
						<v-btn color="green" text @click="atualizarPergunta()"
							>Salvar</v-btn
						>
					</v-card-actions>
				</v-card>
